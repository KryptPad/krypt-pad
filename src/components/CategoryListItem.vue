<template>
    ...
    <v-list-item v-else>
        ...
        <div  class="mb-1" @click.stop>
            ...
            <v-btn color="primary" icon="mdi-check" class="mr-3" @click="renameCategoryAsync(category, title)"></v-btn>
...
function renameCategoryAsync(category, title){
    kpAPI.renameCategoryAsync(category, title);
