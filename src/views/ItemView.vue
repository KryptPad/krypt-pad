        ...
        <v-container class="d-flex flex-column h-100 ">
            <v-row class="flex-grow-0">
                <v-col>
                    ...
                    <v-text-field :value="item.title" @change="item.title = $event.target.value" type="text"
            ...
            <div class="flex-fill d-flex">
                <v-textarea :value="item.notes" @change="item.notes = $event.target.value" label="notes"
